...
(function() {
  var NEGATIVE, NEUTRAL, POSITIVE, debug, enrich, fs, isString, ngramize, thesaurus,
  ...
  exports.Engine = (function() {
    ...
    Engine.prototype.pushEvent = function(event) {
      ...
      _ref = ngramize(event.content, this.ngramSize);
      for (facet in _ref) {
        _ = _ref[facet];
    ...
    Engine.prototype.rateProfiles = function(content, opts) {
      var facet, filter, id, limit, profile, results, score, synonym, _, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6;
      if (opts == null) {
        opts = {};
      }
      ...
      for (id in _ref1) {
        ...
        score = 0;
        _ref2 = ngramize(content, this.ngramSize);
        for (facet in _ref2) {
          _ = _ref2[facet];
          score += (_ref3 = profile[facet]) != null ? _ref3 : 0;
        }
        _ref4 = enrich(content.split(' '));
        for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
          synonym = _ref4[_i];
          _ref5 = ngramize(synonym, this.ngramSize);
          for (facet in _ref5) {
            _ = _ref5[facet];
            score += (_ref6 = profile[facet]) != null ? _ref6 : 0;
          }
        }
