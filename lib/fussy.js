...
(function() {
  ...
  Database = (function() {
    ...
    Database.prototype.learn = function(tagged) {
      var key, keywords, n, ngram, txt, _i, _len, _ref;
      for (txt in tagged) {
        keywords = tagged[txt];
    ...
    Database.prototype.prune = function(threshold, onComplete) {
    ...
    Database.prototype.toFile = function(fileName, onComplete) {
      return fs.writeFile(fileName, this.toString(), function(err) {
        if (err) {
          throw err;
        }
